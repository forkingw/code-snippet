...
<script>
import { getNoticeAterList } from '@/api/contingencyManage/afterDisasterRecovery.js'
...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        ...
        {
          title: '状态',
          dataIndex: 'disasterAfterStatus',
          scopedSlots: { customRender: 'cmNoticeStatus' }
        },
        {
          title: '上报时间',
          dataIndex: 'disasterAfterStartTime',
          customRender (text, record) {
            return text + ' 至 ' + record.disasterAfterEndTime
          }
        },
        {
          title: '操作人',
  ...
  methods: {
    ...
    loadData (parameter) {
      return getNoticeAterList(Object.assign({}, parameter, this.queryParam, {
