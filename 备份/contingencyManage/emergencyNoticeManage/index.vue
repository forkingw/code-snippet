<template>
  <page-header-wrapper>
    <a-card :bordered="false">
      ...
      <div>
        <a-button type="primary" icon="plus" @click="addEmergencyNotice" v-action:add v-if="isHigherThanStreetAccount">新建</a-button>
      </div>
      ...
      >
        ...
        <template slot="action" slot-scope="text, record">
          ...
          <a-space>
            <a v-if="isShowPublishButton(record) && isHigherThanStreetAccount" @click="releaseNotice(record)" v-action:pass>发布</a>
            <a v-if="isShowDetailButton(record)" @click="lookupNotice(record)" v-action:get>查看</a>
            <a v-if="isShowOperationButton(record) && isHigherThanStreetAccount" @click="editNotice(record)" v-action:edit>编辑</a>
            <a v-if="isShowOperationButton(record) && isHigherThanStreetAccount" @click="deleteNotice(record)" v-action:delete>删除</a>
